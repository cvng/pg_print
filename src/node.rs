...
impl fmt::Print for Node {
    fn print(&self, p: &mut fmt::Printer) -> fmt::Result {
        match self.node.as_ref().unwrap() {
            ...
            NodeEnum::GrantStmt(node) => node.print(p),
            ...
            NodeEnum::CreateFunctionStmt(node) => node.print(p),
            ...
            NodeEnum::AccessPriv(node) => node.print(p),
            NodeEnum::CreateOpClassItem(node) => todo!("{:?}", node),
            NodeEnum::TableLikeClause(node) => todo!("{:?}", node),
            NodeEnum::FunctionParameter(node) => node.print(p),
            ...
            NodeEnum::RoleSpec(node) => node.print(p),
            ...
            NodeEnum::List(node) => node.print(p),
