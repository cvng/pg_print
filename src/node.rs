...
impl Printer {
    pub fn node(&mut self, node: &Node) {
        match node.node.as_ref().unwrap() {
            ...
            NodeEnum::RangeVar(node) => node.print(self).unwrap(),
            ...
            NodeEnum::SelectStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::CreateStmt(node) => node.print(self).unwrap(),
            NodeEnum::DefineStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::IndexStmt(node) => node.print(self).unwrap(),
            NodeEnum::CreateFunctionStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::ViewStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::CreateTableAsStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::CreateTrigStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::CreateSchemaStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::ExecuteStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::CreateForeignTableStmt(node) => node.print(self).unwrap(),
            NodeEnum::ImportForeignSchemaStmt(node) => todo!("{:?}", node),
            NodeEnum::CreateExtensionStmt(node) => node.print(self).unwrap(),
            ...
            NodeEnum::ColumnRef(node) => node.print(self).unwrap(),
            ...
            NodeEnum::ResTarget(node) => node.print(self).unwrap(),
            ...
            NodeEnum::ColumnDef(node) => node.print(self).unwrap(),
            NodeEnum::IndexElem(node) => node.print(self).unwrap(),
            NodeEnum::StatsElem(node) => todo!("{:?}", node),
            NodeEnum::Constraint(node) => node.print(self).unwrap(),
            NodeEnum::DefElem(node) => node.print(self).unwrap(),
            ...
            NodeEnum::FunctionParameter(node) => node.print(self).unwrap(),
            ...
            NodeEnum::RoleSpec(node) => node.print(self).unwrap(),
            ...
            NodeEnum::Integer(node) => node.print(self).unwrap(),
            NodeEnum::Float(node) => todo!("{:?}", node),
            NodeEnum::Boolean(node) => todo!("{:?}", node),
            NodeEnum::String(node) => node.print(self).unwrap(),
            NodeEnum::BitString(node) => todo!("{:?}", node),
            NodeEnum::List(node) => node.print(self).unwrap(),
