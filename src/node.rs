...
impl Printer {
    pub fn node(&mut self, n: &Node) {
        match n.node.as_ref().unwrap() {
            ...
            NodeEnum::RangeVar(n) => n.print(self),
            ...
            NodeEnum::SelectStmt(n) => n.print(self),
            ...
            NodeEnum::CreateFunctionStmt(n) => n.print(self),
            ...
            NodeEnum::ViewStmt(n) => n.print(self),
            ...
            NodeEnum::CreateSchemaStmt(n) => n.print(self),
            ...
            NodeEnum::ExecuteStmt(n) => n.print(self),
            ...
            NodeEnum::ColumnRef(n) => n.print(self),
            ...
            NodeEnum::ResTarget(n) => n.print(self),
            ...
            NodeEnum::RoleSpec(n) => n.print(self),
            ...
            NodeEnum::String(n) => n.print(self),
            NodeEnum::BitString(_) => todo!(),
            NodeEnum::List(n) => n.print(self),
