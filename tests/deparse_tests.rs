// https://raw.githubusercontent.com/pganalyze/pg_query.rs/main/tests/deparse_tests.rs

#![allow(non_snake_case)]
#![cfg(test)]

use pg_deparser::deparse;
use pg_query::parse;
...
fn assert_deparse(input: &str, output: &str) {
    ...
    assert_eq!(deparse(&result.protobuf).unwrap(), output);
}
